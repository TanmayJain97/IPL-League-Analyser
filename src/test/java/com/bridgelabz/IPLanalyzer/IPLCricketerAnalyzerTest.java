...
public class IPLCricketerAnalyzerTest {
	...
	public void whenSorted_ShouldGiveMaxBatting_MaxBowlingAvg() throws CSVBuilderException{
		...
		assertEquals("Andre Russell", PName);
	}

	//Test for sorted runs, Wickets Taken
	@Test
	public void whenSorted_ShouldGiveMaxRuns_MaxWicktes() throws CSVBuilderException{
		String PName=(analyser.getCricketerSortedList(CricketerSortingFunction.Order.MAX_RUNS_WCKTS).get(0)).getBatsman().getPlayer();
		assertEquals("Andre Russell", PName);
	}
}
